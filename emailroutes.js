...
router.post("/programare", async (req, res) => {
    ...
    <div style="font-family: Arial, sans-serif; background:#f6f7f9; padding:30px;">
      <div style="max-width:600px; margin:0 auto; background:white; padding:25px; border-radius:12px; box-shadow:0 3px 10px rgba(0,0,0,0.05);">
        <div style="text-align: center;">
          <img src="https://artisanstoma.ro/logocabinet.png" alt="Artisan Stoma" style="width: 160px; margin-bottom: 20px;" />
        </div>
  ...
  const adminHTML = `
    <div style="font-family: Arial, sans-serif; background:#ffffff; padding:20px;">
      <div style="text-align: center;">
        <img src="https://romaniatravelguide.ro/logocabinet.png" alt="Artisan Stoma" style="width: 160px; margin-bottom: 20px;" />
      </div>
  ...
  try {
    ...
    await resend.emails.send({
      from: "Artisan Stoma <office@artisanstoma.ro>",
      to: email,
    ...
    // ----------- EMAIL ADMIN -----------
    await resend.emails.send({
      from: "Programări Website <office@artisanstoma.ro>",
